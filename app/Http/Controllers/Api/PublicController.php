...
class PublicController extends Controller{
	...
	public function topcaccounts(Request $request){
		...
		$accounts 		= Account::select('accounts.id', 'accounts.uuid', 'accounts.avatar', 'accounts.nickname', 'devices.user_num')->where('accounts.admin_id', $user->id)->where('devices.admin_id', $user->id)->rightJoin('devices', 'accounts.did', '=', 'devices.id')->get();
		$accountsArr 	= [];
